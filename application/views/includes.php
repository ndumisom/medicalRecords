<link rel="stylesheet" href="<?php echo base_url();?>template/css/font.css">
        ...
        <link href="<?php echo base_url();?>template/css/medicalrecords.css" media="screen" rel="stylesheet" type="text/css" />
        ...
        <script src="<?php echo base_url();?>template/js/medicalrecords.js" type="text/javascript"></script>
